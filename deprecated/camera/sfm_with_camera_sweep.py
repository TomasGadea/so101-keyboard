...
# Paths for sfm
project_path = Path("/Users/neil/Documents/ETHZ/ROBOT_LEARNING/robot_learning_project/")
...
URDF = "robot_learning_project/calibration/so101_new_calib.urdf"
...
if __name__ == "__main__":
    ...
    print(f"Calculated 3D End Position (Robot): {robot_target_position}")
